...
function require(identifier, callback) {
	...
	if (cache[cacheid]) {
		...
		var r = load(descriptor, cache, pwd, cache[cacheid]);
...
function /*load*/(module/*, cache, pwd, source*/) {
	try {
		...
		arg2.unshift(module.id.match(/(?:.*\/)?/)[0]);
		
		Object.defineProperty(arg1, '$'+module.id, {'get':function(){return exports;}});
		...
		if (typeof module.id !== 'String')
			for (id in module)
				arg1['$'+require.resolve(id).id] = module[id].toString();
